...
var _nextNavigation = require("./nextNavigation");
...
function AppProviderNextApp(props) {
  const pathname = (0, _nextNavigation.usePathname)();
  const searchParams = (0, _nextNavigation.useSearchParams)();
  const {
    push,
    replace
  } = (0, _nextNavigation.useRouter)();
